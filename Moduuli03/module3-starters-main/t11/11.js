...
for (let art of picArray) {
  let article = document.createElement("article")
  let title = article.appendChild(document.createElement("h2"))
  ...
  article.addEventListener("click", function(modal) {
    
    dialog.showModal()
    img.src = art.image.large
    img.alt = art.title
  })

  span.addEventListener("click", function(close) {
    dialog.close()
  })
